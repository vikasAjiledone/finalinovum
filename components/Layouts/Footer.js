            ...
            <div className="row justify-content-center">
              <div className="col-lg-3 col-sm-6">
                <div className="single-footer-widget">
                  ...
                  <h3>Welcome to The Digital Agency</h3>
                  <p>
                    ...
                    balance between innovation and familiarity. With our
                    services, we strive to make sure that your brand stands out
                    from the competition in an effective and creative way.
                  </p>
                ...
                <div className="single-footer-widget">
                  ...
                  <ul className="get-in-touch">
                    <li>
                      ...
                      No 53, 11th Cross ,Near Deepa Complex, Papareddy palya,
